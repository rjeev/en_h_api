...
app.post('/social/google/headline', async (req, res, next) => {

	try {
			let { headline, description, audience, tone, n } = req.body
		
			// append the word hello before the start of the prompt text
			let prompt = `Create a short, engaging google ad headline based on metadata provided:\n###\n` +
  ...
  app.post('/social/google/description', async (req, res, next) => {

	try {
			let { headline, description, audience, tone, n } = req.body
		
			// append the word hello before the start of the prompt text
			let prompt = `Create a long, engaging google ad description based on metadata provided:\n###\n` +
  ...
  app.post('/social/google/keywords', async (req, res, next) => {

	try {
			let { headline, description, audience, } = req.body
		
			// append the word hello before the start of the prompt text
			let prompt = `Generate dozens of keywords for a Google AdWords Campaign based on metadata provided:\n###\n` +
